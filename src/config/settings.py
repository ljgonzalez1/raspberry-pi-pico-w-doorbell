...
TELEGRAM_MESSAGE = "¡Sonó el timbre!"

PROVIDER_NODE_RED_ENABLED = False
NODE_RED_CONFIG = {
    'protocol': 'http',
...
PROVIDER_SIMPLE_GET_ENABLED = False
SIMPLE_GET_CONFIG = {
...
PROVIDER_TWILIO_WHATSAPP_ENABLED = False
...
PROVIDER_TWILIO_SMS_ENABLED = False
TWILIO_SMS_CONFIG = {
    'account_sid': creds.TWILIO_ACCOUNT_SID,
    'auth_token': creds.TWILIO_AUTH_TOKEN,
